...
export default function Dashboard1() {
  return (
          ...
          <section className="flex gap-x-3     ">
              ...
              <div className=" p-2 h-[160px] max-w-[410px] w-full  rounded-[32px] bg-gradient-to-r from-white from-20% to-[#5BB9C5] flex flex-col gap-y-3 px-6">
                ...
                <span className=" flex justify-start w-full">
                  ...
                  <img src="/perforamce bar.png" className=" w-full min-w-[130px] max-w-[220px] h-[100px] ml-[46px] objeect-contain" />
                </span>
              </div>
              ...
              <div className=" p-2 h-[160px] max-w-[410px] w-full   rounded-[32px] bg-gradient-to-r from-white from-20% to-[#5BB9C5] flex flex-col gap-y-3   px-6">
                ...
                <p className="text-[40px] font-semibold ">80%</p>
            ...
            <div className="p-2 h-[160px] max-w-[410px] w-full  rounded-[32px] rounded-tr-[36px] bg-gradient-to-r from-white from-20% to-[#5BB9C5]  pl-6 flex relative">
              <div className="  flex-col gap-y-3   ">
                <p className="text-[16px]  text-dark inline-block">Temperature</p>
                <div className="flex items-baseline gap-5 ">
                  <p className="text-[40px] font-semibold mt-3 ">23°c</p>
                  <span className="flex items-center gap-2"><img className="h-5 w-2" src="/Temperature-icon.png" /><p className="text-[10px] inline-block ">Condition normal</p></span>
                </div>
              </div>
              <div className="flex flex-col">
                <span className="h-[50%]" >
                  ...
                  <img className="z-10 w-full max-w-[92px] h-[55px] absolute top-5 right-3.5" src="/clouds.png " />
                </span>
