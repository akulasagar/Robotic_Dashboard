          ...
          <div className="flex flex-col gap-[26px] ">
            ...
            <div className="w-full bg-white h-[350px] rounded-[14px] p-[24px]">
              ...
              <div className="max-h-[230px] overflow-y-auto">
                {selectedRobot.event_logs &&
                selectedRobot.event_logs.length > 0 ? (
                  selectedRobot.event_logs.map((each, index) => (
                    ...
                    >
                      ...
                      >
                        <span
                          className="h-2.5 w-2.5 rounded-[50%] mr-2"
                          style={{
                            backgroundColor:
                              each.status === "idle"
                                ? "orange"
                                : each.status === "patrolling"
                                ? "green"
                                : "blue",
                          }}
                        ></span>
            ...
            <div
              className="h-[665px] h-auto  w-full rounded-[14px] bg-white p-[24px] "
              id="video-feed"
            >
              ...
              <div className="flex flex-col relative mt-5 ">
                ...
                <Link
                  to="/controls"
                  className="absolute top-1.5 right-1.5 rounded-[14px] bg-transparent border border-white px-4 py-2 text-white z-200 "
                >
                  Manual Control
                </Link>
              </div>
